...
import 'package:library_booking_system/Screens/Booking/booking_record.dart';
...
class Management {
  ...
  getCarrelBooking(bookingCarrel, context) async {
    var firebaseUser = await FirebaseAuth.instance.currentUser;
    FirebaseFirestore.instance
        .collection('BookingCarrel')
        .doc(firebaseUser.uid)
        .set({
          'selectedBookingdate': bookingCarrel.selectedBookingdate,
          'selectedRoom': bookingCarrel.selectedRoom,
          'selectedTimeSlot': bookingCarrel.selectedTimeSlot
        })
        .then((value) => Navigator.push(
